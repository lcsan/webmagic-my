...
public class CSVPageModelPipeline2 implements PageModelPipeline<Yao9> {

    private final static CsvWriter csvWriter;

    static {
        csvWriter = new CsvWriter("d:/笑话9yao2.csv", ',', Charset.forName("UTF-8"));
    ...
    @Override
    public void process(Yao9 t, Task task) {
        try {
