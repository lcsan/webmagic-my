...
public class HuabanProcessor implements PageProcessor {
    ...
    public static void main(String[] args) {
        Spider.create(new HuabanProcessor()).thread(5).addPipeline(new FilePipeline("/data/webmagic/test/"))
                .setDownloader(new PhantomjsDownloader()).addUrl("http://huaban.com/").runAsync();
    }
}
