...
public class Site {
    ...
    /**
     * Downloader is supposed to store response cookie. Disable it to ignore all
     * cookie fields and stay clean. Warning: Set cookie will still NOT work if
     * disableCookieManagement is true.
     * 
