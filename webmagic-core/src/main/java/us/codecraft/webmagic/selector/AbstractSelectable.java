...
public abstract class AbstractSelectable implements Selectable {
    ...
    public Selectable jsonPath(String jsonPath) {
        JsonPathSelector regexSelector = Selectors.json(jsonPath);
        return selectList(regexSelector, getSourceTexts());
    }

    @Override
    public Selectable filter(String regex) {
        FilterSelector regexSelector = Selectors.filter(regex);
        return selectList(regexSelector, getSourceTexts());
    };

    @Override
    public Selectable mixe(String regex) {
        MixeSelector regexSelector = Selectors.mixe(regex);
        return selectList(regexSelector, getSourceTexts());
    };
    ...
    public Selectable replace(String regex, String replacement) {
        ...
        return selectList(replaceSelector, getSourceTexts());
    }
