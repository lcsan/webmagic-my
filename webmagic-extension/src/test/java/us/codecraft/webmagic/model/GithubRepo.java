...
public class GithubRepo extends BaseRepo {
	...
	@ExtractBy("xpath('//ul[@class='pagehead-actions']/li[2]//a[@class='social-count']/text()').replace('\\D','')")
	private int fork;

	public static void main(String[] args) {
		OOSpider.create(Site.me().setSleepTime(100), new ConsolePageModelPipeline(), GithubRepo.class)
