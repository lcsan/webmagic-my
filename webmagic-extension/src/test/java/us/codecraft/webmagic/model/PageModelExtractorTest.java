...
public class PageModelExtractorTest {
	...
	public void testXpath() throws Exception {
		ModelDateStr modelDate = (ModelDateStr) AnnotationPageModelExtractor.create(ModelDateStr.class)
	...
	public void testExtractDate() throws Exception {
		ModelDate modelDate = (ModelDate) AnnotationPageModelExtractor.create(ModelDate.class)
				.process(pageMocker.getMockPage());
	...
	public void testExtractInt() throws Exception {
		ModelInt modelDate = (ModelInt) AnnotationPageModelExtractor.create(ModelInt.class)
				.process(pageMocker.getMockPage());
	...
	public void testExtractList() throws Exception {
		ModelStringList modelDate = (ModelStringList) AnnotationPageModelExtractor.create(ModelStringList.class)
				.process(pageMocker.getMockPage());
		assertThat(modelDate.links).containsExactly("http://webmagic.io/list/1", "http://webmagic.io/list/2",
				"http://webmagic.io/list/3", "http://webmagic.io/list/4");
	}

	@Test
	public void testExtractIntList() throws Exception {
		ModelIntList modelDate = (ModelIntList) AnnotationPageModelExtractor.create(ModelIntList.class)
				.process(pageMocker.getMockPage());
	...
	public void testExtractDateList() throws Exception {
		ModelDateList modelDate = (ModelDateList) AnnotationPageModelExtractor.create(ModelDateList.class)
				.process(pageMocker.getMockPage());
		assertThat(modelDate.dates).containsExactly(DateUtils.parseDate("20170601", "yyyyMMdd"),
				DateUtils.parseDate("20170602", "yyyyMMdd"), DateUtils.parseDate("20170603", "yyyyMMdd"),
				DateUtils.parseDate("20170604", "yyyyMMdd"));
	}

	@Test
	public void testExtractCustomList() throws Exception {
		ModelCustomList modelDate = (ModelCustomList) AnnotationPageModelExtractor.create(ModelCustomList.class)
				.process(pageMocker.getMockPage());
		assertThat(modelDate.dates).containsExactly(DateUtils.parseDate("20170601", "yyyyMMdd"),
				DateUtils.parseDate("20170602", "yyyyMMdd"), DateUtils.parseDate("20170603", "yyyyMMdd"),
				DateUtils.parseDate("20170604", "yyyyMMdd"));
	...
	public void testExtractJson() throws Exception {
		ModelJsonStr modelDate = (ModelJsonStr) AnnotationPageModelExtractor.create(ModelJsonStr.class)
	...
	public void testExtractByUrl() throws Exception {
		ModelUrl modelDate = (ModelUrl) AnnotationPageModelExtractor.create(ModelUrl.class)
				.process(pageMocker.getMockJsonPage());
		assertThat(modelDate.name).isEqualTo("webmagic");
	}
}
