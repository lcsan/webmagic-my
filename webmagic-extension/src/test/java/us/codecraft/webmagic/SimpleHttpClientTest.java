...
/**
 * @author code4crafter@gmail.com Date: 2017/6/3 Time: 下午2:54
 */
public class SimpleHttpClientTest {
	...
	public static class Weather implements AfterExtractor {
		...
		public String toString() {
			return "Weather{" + "location='" + location + '\'' + ", lowTemperature=" + lowTemperature
					+ ", highTemperature=" + highTemperature + ", desc='" + desc + '\'' + '}';
		}
	}
	...
	public void test() throws Exception {
		Weather weather = new SimpleHttpClient(Site.me()).get("http://www.weather.com.cn/weather/101020100.shtml",
				Weather.class);
